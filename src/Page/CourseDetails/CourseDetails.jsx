      ...
      <div>
        <section className="text-gray-600 body-font" ref={ref}>
          <div className="container px-5 py-10 mx-auto flex flex-col">
            {/* <button onClick={handlePrint} className="print__button text-green-400 font-bold">Dowload PDF</button>  */}
            <Pdf targetRef={ref} filename="Details.pdf" scale={0.7} >
        {({ toPdf }) => <button onClick={toPdf} className="print__button text-green-400 font-bold">Download PDF</button>}
      </Pdf>
